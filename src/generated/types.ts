...
export const PullRequestFieldsFragmentDoc = gql`
  ...
  timelineItems(
    itemTypes: [PULL_REQUEST_COMMIT, LABELED_EVENT, HEAD_REF_FORCE_PUSHED_EVENT]
    first: 100
  ) {
    edges {
      node {
